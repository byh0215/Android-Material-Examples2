...
public class SlidingTabsBasicFragment extends Fragment {
    ...
    class SamplePagerAdapter extends PagerAdapter {
        final String [] TITLES = {"首页", "购物车", "我的订单"};
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view []= {getActivity().getLayoutInflater().inflate(R.layout.item_sliding_pager,
                    container, false),getActivity().getLayoutInflater().inflate(R.layout.item_sliding_pager2,
                    container, false),getActivity().getLayoutInflater().inflate(R.layout.item_sliding_pager3,
                    container, false)};
